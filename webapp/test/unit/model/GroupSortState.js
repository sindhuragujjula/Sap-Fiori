sap.ui.define([
	...
	QUnit.test("Should always return a sorter when sorting", function(assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("EvKa").length, 1, "The sorting by EvKa returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by EvKa and there was a grouping before", function(assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "");

		this.oGroupSortState.sort("EvKa");
