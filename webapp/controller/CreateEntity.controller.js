sap.ui.define([
	...
	return BaseController.extend("ka.controller.CreateEntity", {
		...
		_onCreate: function(oEvent) {
			...
			var oContext = this._oODataModel.createEntry("ArticleSet", {
		...
		_fnEntityCreated: function(oData) {
			var sObjectPath = this.getModel().createKey("ArticleSet", oData);
		...
		_getFormFields: function(oSimpleForm) {
			...
			for (var i = 0; i < aFormContent.length; i++) {
				...
				if (sControlType === "sap.m.Input" || sControlType === "sap.m.DateTimeInput" ||
					sControlType === "sap.m.CheckBox" || sControlType === "sap.m.TextArea") {
					aControls.push({
