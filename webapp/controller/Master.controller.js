...
sap.ui.define([
	...
	return BaseController.extend("ka.controller.Master", {
		...
		onSearch: function(oEvent) {
			...
			if (sQuery) {
				this._oListFilterState.aSearch = [new Filter("EvKa", FilterOperator.EQ, sQuery)];
			} else {
				...
				function(mParams) {
					...
					if (!mParams.list.getSelectedItem()) {
						this.getRouter().navTo("object", {
							EvKa: encodeURIComponent(mParams.firstListitem.getBindingContext().getProperty("EvKa"))
						}, true);
					}
				}.bind(this),
				function(mParams) {
		...
		_showDetail: function(oItem) {
			...
			this.getRouter().navTo("object", {
				EvKa: encodeURIComponent(oItem.getBindingContext().getProperty("EvKa"))
			}, bReplace);
		},
